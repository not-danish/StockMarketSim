...
<template>
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 lg:flex-nowrap">
        <OrderBook class="lg:max-h-[calc(100vh-350px)] lg:min-h-[550px] xl:h-[650px]"/>
            <StockChart class="w-3/5 lg:max-h-[calc(100vh-350px)] lg:min-h-[550px] xl:h-[650px]">
                <div class="flex justify-between">
                    <span class="text-4xl text-slate-100 text-left">AAPL<br></span>
                    <div class="text-right relative text-green-500">
                        <span class="text-4xl">$500</span>
                        <span class="text-md">+2.48%</span>
                    
                    </div>
                </div>

                <span class="text-md">Apple Inc.</span>
        ...
        <TradeCard class="lg:max-h-[calc(100vh-350px)] lg:min-h-[550px]"/>
